...
def reach(res1d_network):
    return res1d_network.network.reaches.r_100l1


@pytest.fixture
def river_reach(res1d_river_network):
    return res1d_river_network.network.reaches.river
...
def many_catchments(res1d_catchments):
    catchments = res1d_catchments.network.catchments
    return [
...
def structure(res1d_network):
    return res1d_network.network.structures["119w1"]
