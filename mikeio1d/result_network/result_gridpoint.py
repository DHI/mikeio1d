...
class ResultGridPoint(ResultLocation):
    ...
    def _set_static_attributes(self):
        ...
        self._set_static_attribute("reach_name", self.reach.Name)
        self._set_static_attribute("chainage", self.gridpoint.Chainage)
        self._set_static_attribute("xcoord", self.gridpoint.X)
    ...
    def _add_to_result_quantity_maps(self, quantity_id, result_quantity):
        ...
        self._add_to_result_quantity_map(quantity_id, result_quantity, reach_result_quantity_map)

        reaches_result_quantity_map = self.res1d.network.reaches.result_quantity_map
        self._add_to_result_quantity_map(quantity_id, result_quantity, reaches_result_quantity_map)
